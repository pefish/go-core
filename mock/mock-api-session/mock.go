...
// Source: github.com/pefish/go-core/api-session (interfaces: IApiSession)
...
func (m *MockIApiSession) Api() _interface.IApi {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Api")
	ret0, _ := ret[0].(_interface.IApi)
	return ret0
}
...
func (m *MockIApiSession) SetApi(arg0 _interface.IApi) {
	m.ctrl.T.Helper()
