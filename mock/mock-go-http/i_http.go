...
import (
	...
	gorequest "github.com/pefish/go-http/gorequest"
	http "net/http"
	reflect "reflect"
)
...
// GetRequestClient mocks base method
func (m *MockIHttp) GetRequestClient() *gorequest.SuperAgent {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRequestClient")
	ret0, _ := ret[0].(*gorequest.SuperAgent)
	return ret0
}

// GetRequestClient indicates an expected call of GetRequestClient
func (mr *MockIHttpMockRecorder) GetRequestClient() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRequestClient", reflect.TypeOf((*MockIHttp)(nil).GetRequestClient))
}
